...
import importCoinTracking from './../../request/trade/importCoinTracking'

const error = {
  color: 'red'
}

class ImportCoinTracking extends React.Component {
  ...
  handleOnSend = () => {
    ...
    importCoinTracking(this.state.file)
      .then(res => {
        this.setState({
...
export default ImportCoinTracking